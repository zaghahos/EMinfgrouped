...
for(i in 1:ncol(sim2)){
  Fr[,i]<- table(cut(sim2[,i],breaks=c(-Inf,62,64,66,68,70,72,74,76,78,Inf)))
...
for(i in 1:ncol(sim2)){
  simdata2[,1,i]<- c(-Inf,62,64,66,68,70,72,74,76,78)
  simdata2[,2,i]<- c(62,64,66,68,70,72,74,76,78,Inf)
  simdata2[,3,i]<- Fr[,i]
...
for (i in 1:30){
  ...
  Mynewarray2[1,1,i]<- 61
  Mynewarray2[10,1,i]<- 79
}
#Mynewarray
...
for(i in 1:ncol(sim4)){
  Fr[,i]<- table(cut(sim4[,i],breaks=c(-Inf,62,64,66,68,70,72,74,76,78,Inf)))
...
for(i in 1:ncol(sim4)){
  simdata4[,1,i]<- c(-Inf,62,64,66,68,70,72,74,76,78)
  simdata4[,2,i]<- c(62,64,66,68,70,72,74,76,78,Inf)
  simdata4[,3,i]<- Fr[,i]
...
for (i in 1:30){
  ...
  Mynewarray4[1,1,i]<- 61
  Mynewarray4[10,1,i]<- 79
}
#Mynewarray
...
for(i in 1:ncol(sim6)){
  ...
  Fr[,i]<- table(cut(sim6[,i],breaks=c(-Inf,62,64,66,68,70,72,74,76,78,Inf)))
  #print(Fr)
}
...
for(i in 1:ncol(sim6)){
  simdata6[,1,i]<- c(-Inf,62,64,66,68,70,72,74,76,78)
  simdata6[,2,i]<- c(62,64,66,68,70,72,74,76,78,Inf)
  simdata6[,3,i]<- Fr[,i]
...
for (i in 1:30){
  ...
  Mynewarray6[1,1,i]<- 61
  Mynewarray6[10,1,i]<- 79
}
#Mynewarray
...
for(i in 1:ncol(sim7)){
  #sim1.cut<- cut(sim[,1],breaks=c(-Inf,65,66,67,68,69,70,71,Inf))
  Fr[,i]<- table(cut(sim7[,i],breaks=c(-Inf,62,64,66,68,70,72,74,76,78,Inf)))
  #print(Fr)
}
...
for(i in 1:ncol(sim7)){
  simdata7[,1,i]<- c(-Inf,62,64,66,68,70,72,74,76,78)
  simdata7[,2,i]<- c(62,64,66,68,70,72,74,76,78,Inf)
  simdata7[,3,i]<- Fr[,i]
...
for (i in 1:30){
  ...
  Mynewarray7[1,1,i]<- 61
  Mynewarray7[10,1,i]<- 79
}
#Mynewarray
...
xtable(MUEST10,caption = "Estimate of MU along with its standard deviation (std) and mean squared error (MSE)
       using 4 methods for sample sizes: 50,100,500,1000 over Equal Intervals (number of classes=10) ")
...
par(mfrow=c(2,2))
par(mar=c(4,4,4,4))
boxplot(MCompare2,col="aquamarine",ylab="Mean",ylim=c(67.3,68.5),las=2,cex.axis=0.70)
abline(h=68)
title("n=50")

boxplot(MCompare4,col="aquamarine",ylab="Mean",ylim=c(67.3,68.5),las=2,cex.axis=0.70)
abline(h=68)
title("n=150")

boxplot(MCompare7,col="aquamarine",ylab="Mean",ylim=c(67.3,68.5),las=2,cex.axis=0.70)
abline(h=68)
title("n=500")

boxplot(MCompare6,col="aquamarine",ylab="Mean",ylim=c(67.3,68.5),las=2,cex.axis=0.70)
abline(h=68)
title("n=1000")
dev.off()
##################################################################
...
par(mfrow=c(2,2))
par(mar=c(4,4,4,4))
boxplot(SDCompare2,col="chartreuse1",ylab="Var",ylim=c(1.7,5.3),las=2,cex.axis=0.70)
abline(h=3.24)
title("n=50")

boxplot(SDCompare4,col="chartreuse1",ylab="var",ylim=c(1.7,5.3),las=2,cex.axis=0.70)
abline(h=3.24)
title("n=150")

boxplot(SDCompare7,col="chartreuse1",ylab="var",ylim=c(1.7,5.3),las=2,cex.axis=0.70)
abline(h=3.24)
title("n=500")

boxplot(SDCompare6,col="chartreuse1",ylab="var",ylim=c(1.7,5.3),las=2,cex.axis=0.70)
abline(h=3.24)
title("n=1000")
