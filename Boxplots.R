...
#############################################################################################################
#pdf("UnivariateMU11-Dec2021.pdf")
#pdf("UnivariateMU11-July2022.pdf")
par(mfrow=c(2,2))
par(mar=c(4,4,4,4))

boxplot(C,main=expression(paste("Estimation of ", mu,  " Using MLE Algorithm"))
         # "Estimation of Mu using MLE Algorithm"
        ,xlab="Sample size",
        ylab=expression(mu),col=c("blue","blue","blue","blue","blue",
                          "red","red","red","red","red",
                          "green","green","green","green","green"),las=2,cex.axis=0.70,cex.main=0.8,ylim=c(67,69.5))
abline(h=68)
legend("topright",c("8 bins","15 bins","30 bins"),fill=c("blue","red","green"),border="black",cex=0.5)

boxplot(A,main=expression(paste("Estimation of ", mu,  " Using EM Algorithm")),xlab="Sample size",
        ylab=expression(mu),col=c("blue","blue","blue","blue","blue",
                          "red","red","red","red","red",
                          "green","green","green","green","green"),las=2,cex.axis=0.70,cex.main=0.8,ylim=c(67,69.5))
abline(h=68)
...
boxplot(B,main=expression(paste("Estimation of ", mu,  " Using MCEM Algorithm")),xlab="Sample size",
        ylab=expression(mu),col=c("blue","blue","blue","blue","blue",
                          "red","red","red","red","red",
                          "green","green","green","green","green"),las=2,cex.axis=0.70,cex.main=0.8,ylim=c(67,69.5))
abline(h=68)
...
pdf("UnivariateVar-July2022.pdf")
par(mfrow=c(2,2))
par(mar=c(4,4,4,4))

boxplot(CC,main=expression(paste("Estimation of ", sigma^2,  " Using MLE Algorithm")),xlab="Sample size",
        ylab=expression(sigma^2),col=c("blue","blue","blue","blue","blue",
                              "red","red","red","red","red",
                              "green","green","green","green","green"),las=2,cex.axis=0.70,cex.main=0.7,ylim=c(3,12))
abline(h=6.25)
legend("topright",c("8 bins","15 bins","30 bins"),fill=c("blue","red","green"),border="black",cex=0.5)



boxplot(AA,main=expression(paste("Estimation of ", sigma^2,  " Using EM Algorithm")),xlab="Sample size",
        ylab=expression(sigma^2),col=c("blue","blue","blue","blue","blue",
                              "red","red","red","red","red",
                              "green","green","green","green","green"),las=2,cex.axis=0.70,cex.main=0.7,ylim=c(3,12))
abline(h=6.25)
...
boxplot(BB,main=expression(paste("Estimation of ", sigma^2,  " Using MCEM Algorithm")),xlab="Sample size",
        ylab=expression(sigma^2),col=c("blue","blue","blue","blue","blue",
                              "red","red","red","red","red",
                              "green","green","green","green","green"),las=2,cex.axis=0.70,cex.main=0.7,ylim=c(3,12))
abline(h=6.25)
