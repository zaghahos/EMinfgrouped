...
#boxplot(D,main="Estimation of MU using MLE Ignoring grouping",xlab="sample Size",
 #       ylab="Mean",col=c("blue","blue","blue","blue","blue",
  #                        "red","red","red","red","red",
 #                         "green","green","green","green","green"),las=2,cex.axis=0.70,cex.main=0.7,ylim=c(65.5,72.5))
#abline(h=68)
...
boxplot(C,main="Estimation of MU using MLE EXACT",xlab="sample Size",
        ylab="Mean",col=c("blue","blue","blue","blue","blue",
                          "red","red","red","red","red",
                          "green","green","green","green","green"),las=2,cex.axis=0.70,cex.main=0.8,ylim=c(65.5,72.5))
abline(h=68)
legend("topright",c("8 bins","15 bins","30 bins"),fill=c("blue","red","green"),border="black",cex=0.5)
...
boxplot(CC,main="Estimation of Variance using MCEM Algorithm",xlab="sample Size",
        ylab="Mean",col=c("blue","blue","blue","blue","blue",
                          "red","red","red","red","red",
                          "green","green","green","green","green"),las=2,cex.axis=0.70,ylim=c(3,12))
abline(h=6.25)
...
boxplot(DD,main="Estimation of Variance using MCEM Algorithm",xlab="sample Size",
        ylab="Mean",col=c("blue","blue","blue","blue","blue",
                          "red","red","red","red","red",
                          "green","green","green","green","green"),las=2,cex.axis=0.70,ylim=c(3,12))
abline(h=6.25)
#############################################################################################################
#############################################################################
pdf("UnivariateVarNew.pdf")
par(mfrow=c(2,2))
par(mar=c(4,4,4,4))

#boxplot(DD,main="Estimation of Variance using MLE Ignore Grouping",xlab="sample Size",
